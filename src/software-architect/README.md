...
- **Purpose:** High-level software design. Reach for it after requirements are agreed and before implementation planning, to decide *how* the system should be structured and *why*.
